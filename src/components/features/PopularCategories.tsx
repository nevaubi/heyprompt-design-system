...
const categories = [
  { name: 'Marketing', count: 1234, color: 'from-pink-500 to-rose-500' },
  { name: 'Development', count: 892, color: 'from-blue-500 to-indigo-500' },
  { name: 'Design', count: 756, color: 'from-purple-500 to-violet-500' },
  { name: 'Writing', count: 1456, color: 'from-green-500 to-emerald-500' },
  { name: 'Business', count: 543, color: 'from-orange-500 to-amber-500' },
  { name: 'Education', count: 678, color: 'from-teal-500 to-cyan-500' },
  { name: 'Research', count: 432, color: 'from-red-500 to-pink-500' },
  { name: 'Content', count: 987, color: 'from-indigo-500 to-blue-500' }
];
